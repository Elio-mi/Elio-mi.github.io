...
![img](https://img-blog.csdnimg.cn/b09a197213684a47a54cdae7e39fb30e.png)![点击并拖拽以移动](<!-- 原始路径: data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw== - 图片文件不存在 -->)编辑

## 1.3一些关于树的概念：

![img](https://img-blog.csdnimg.cn/9c687c1c386b4172b717eada6cbcfe9b.png)![点击并拖拽以移动](<!-- 原始路径: data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw== - 图片文件不存在 -->)树的概念的对照图
...
![img](https://img-blog.csdnimg.cn/e78674335d56491492dd136e08910b05.png)![点击并拖拽以移动](<!-- 原始路径: data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw== - 图片文件不存在 -->)孩子兄弟表示法的例子
...
![img](https://img-blog.csdnimg.cn/7745ba60c75840d483a9487eca470a2d.png)![点击并拖拽以移动](<!-- 原始路径: data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw== - 图片文件不存在 -->)二叉树的例子
...
![img](https://img-blog.csdnimg.cn/074f1b48f1b14b47b474531abb77b25d.png)![点击并拖拽以移动](<!-- 原始路径: data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw== - 图片文件不存在 -->)满二叉树和完全二叉树
...
![image-20221125215435558](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20221125215435558.png - 图片需要手动处理 -->)

<u>**可得：向上调整的时间复杂度为O(N);**</u>

②向上调整：

![image-20221125215123008](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20221125215123008.png - 图片需要手动处理 -->)
...
![image-20221126110439058](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20221126110439058.png - 图片需要手动处理 -->)
...
![image-20221205181803252](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20221205181803252.png - 图片需要手动处理 -->)
