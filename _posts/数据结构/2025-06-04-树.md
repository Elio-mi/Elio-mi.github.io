...
![img](/assets/img/remote/img-blog.csdnimg.cn/12dc61f413cb8c6156756250.png)<!-- 图片已移除：点击并拖拽以移动 -->编辑

## 1.3一些关于树的概念：

![img](/assets/img/remote/img-blog.csdnimg.cn/7af636f590bcf22918fd144f.png)<!-- 图片已移除：点击并拖拽以移动 -->树的概念的对照图
...
![img](/assets/img/remote/img-blog.csdnimg.cn/bbde0074f80df9afaa548bfc.png)<!-- 图片已移除：点击并拖拽以移动 -->孩子兄弟表示法的例子
...
![img](/assets/img/remote/img-blog.csdnimg.cn/9ab1dac4fb6c7ee063333e30.png)<!-- 图片已移除：点击并拖拽以移动 -->二叉树的例子
...
![img](/assets/img/remote/img-blog.csdnimg.cn/8545d68d713fdbe9bb3fcb81.png)<!-- 图片已移除：点击并拖拽以移动 -->满二叉树和完全二叉树
...
<!-- 图片已移除：image-20221125215435558 -->

<u>**可得：向上调整的时间复杂度为O(N);**</u>

②向上调整：

<!-- 图片已移除：image-20221125215123008 -->
