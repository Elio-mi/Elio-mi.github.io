...
> ```
>
> ![image-20230729091522207](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230729091522207.png - 图片需要手动处理 -->)

### Ⅰ.  Ⅱ继承的定义

### Ⅰ . Ⅱ . Ⅰ定义的格式

> ![image-20230729092327276](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230729092327276.png - 图片需要手动处理 -->)

### Ⅰ . Ⅱ. Ⅱ 继承关系和访问限定符

> ![image-20230729102543346](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230729102543346.png - 图片需要手动处理 -->)
...
> ![image-20230729165556716](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230729165556716.png - 图片需要手动处理 -->)
>
> ```cpp
> class Person
> {
...
>
> **总结为如下图：**
> ![image-20230729172730865](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230729172730865.png - 图片需要手动处理 -->)
>
> ```cpp
> class Person
> {
...
> ```
>
> ![image-20231018144418175](<!-- 原始路径: C:/Users/jason/AppData/Roaming/Typora/typora-user-images/image-20231018144418175.png - 图片文件不存在 -->)
...
>
> 菱形继承：菱形继承是多继承的一种特殊情况。![image-20230729173606178](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230729173606178.png - 图片需要手动处理 -->)
