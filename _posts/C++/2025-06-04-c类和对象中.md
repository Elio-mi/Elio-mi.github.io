...
> <u>将const修饰的“成员函数”</u>称之为const成员函数，const修饰类成员函数，<u>实际修饰该成员函数 隐含的this指针，表明在该成员函数中不能对类的任何成员进行修改。</u><!-- 图片已移除：image-20230401161100626 -->
