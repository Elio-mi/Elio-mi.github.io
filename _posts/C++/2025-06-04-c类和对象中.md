...
>
> ![image-20230326225033559](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230326225033559.png - 图片需要手动处理 -->)
...
> ```
>
> ![	](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230327135124078.png - 图片需要手动处理 -->)
>
...
> 如下：
>
> ![image-20230327214701482](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230327214701482.png - 图片需要手动处理 -->)
>
> ⑤拷贝构造函数典型调用场景：
>
> - 实现了析构函数的情况。
...
> <u>将const修饰的“成员函数”</u>称之为const成员函数，const修饰类成员函数，<u>实际修饰该成员函数 隐含的this指针，表明在该成员函数中不能对类的任何成员进行修改。</u>![image-20230401161100626](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230401161100626.png - 图片需要手动处理 -->)
