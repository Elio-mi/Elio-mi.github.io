...
> ②必须是**父类**的**指针或者引用**去调。
>
> ![image-20230730221817563](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230730221817563.png - 图片需要手动处理 -->)
...
> ![image-20230730223713615](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230730223713615.png - 图片需要手动处理 -->)
...
>
> ![image-20230731080317735](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230731080317735.png - 图片需要手动处理 -->)
>
> ```cpp
> // 针对上面的代码我们做出以下改造
...
> 上面分析了这个半天了那么多态的原理到底是什么？还记得这里`Func`函数传`Person`调用的 `Person::BuyTicket`，传Student调用的是`Student::BuyTicket`.![image-20230731090808387](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230731090808387.png - 图片需要手动处理 -->)
> ```cpp
> class Person 
> {
> 	public:
...
>
> ![image-20230731091039323](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230731091039323.png - 图片需要手动处理 -->)
...
> ```
>
> 观察下图中的监视窗口中我们发现看不见func3和func4。这里是编译器的监视窗口故意隐藏了这 两个函数，也可以认为是他的一个小bug。那么我们如何查看d的虚表呢？下面我们使用代码打印 出虚表中的函数。![image-20230731093846804](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230731093846804.png - 图片需要手动处理 -->)	
> ```cpp
> typedef void(*VFPTR) ();
...
> ```
>
> ![](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230731101946344.png - 图片需要手动处理 -->)
...
> ```
>
> ![image-20230731124321778](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20230731124321778.png - 图片需要手动处理 -->)
