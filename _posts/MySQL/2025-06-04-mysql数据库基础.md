...
![image-20240308095010333](/assets/img/posts/MySQL/assets/image-20240308095010333.png)
...
![image-20240308095139368](/assets/img/posts/MySQL/assets/image-20240308095139368.png)
...
- 查询表中的数据
  ...
  ![image-20240308100922625](/assets/img/posts/MySQL/assets/image-20240308100922625.png)

### 1.5MySQL架构

MySQL 是一个可移植的数据库，几乎能在当前所有的操作系统上运行，如 Unix/Linux、Windows、Mac 和 Solaris。各种系统在底层实现方面各有不同，但是 MySQL 基本上能保证在各个平台上的物理体系结构的一致性 

![image-20240308103807759](/assets/img/posts/MySQL/assets/image-20240308103807759.png)
...
![image-20240308103153924](/assets/img/posts/MySQL/assets/image-20240308103153924.png)
