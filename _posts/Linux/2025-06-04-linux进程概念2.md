...
>
> ![image-20231101194517936](/assets/img/remote/gitee.com/795a22620217b5318f14cc28.png)
>
> 这里显示的就是我们当前操作系统中在运行的进程，那些蓝色的数字就是进程的`pid`:
>
> 当进程存在时，我们可以通过`pid`来进入文件来查看进程相关的属性：
>
> ![image-20231102154929933](/assets/img/remote/gitee.com/6aee2c70ce0768a19f22752a.png)
>
> 当我们kill这个进程的时候，当我再次查看`pid`对应的文件：
>
> ![image-20231102155040719](/assets/img/remote/gitee.com/6dfba6cce72c15c463f66ced.png)
>
> 大多数进程信息同样可以使用top和ps这些用户级工具来获取  
>
> `ps aux | gep test | grep -v grep`
>
> ![image-20231101194552370](/assets/img/remote/gitee.com/bfa4a45b16afe3e8a9a6d8fd.png)
>
...
> 运行如下的结果：
>
> ![image-20231102165708920](/assets/img/remote/gitee.com/08666bff5ea8242b23b8ec65.png)
>
>  然后我们反复的去运行然后观察：
>
> 我们发现父进程的`PID`一直没有变化，但是进程`PID`却在变化。那么这个没有变化的进程是谁呢？是不是我们每次用命令行运行程序的时候都是他来帮我们创建的呢？
>
> ![image-20231102170042615](/assets/img/remote/gitee.com/86d94795c81af4339b2b1549.png)
>
> 接下来我们用`ps`命令去寻找一下这个进程：
>
> ![image-20231102170543491](/assets/img/remote/gitee.com/b3c87ed28680124b308e1281.png)
>
...
<img src="/assets/img/remote/gitee.com/2042f49b242ca4e4fd6c2372.png" alt="image-20231101194631231" style="zoom: 50%;" />
