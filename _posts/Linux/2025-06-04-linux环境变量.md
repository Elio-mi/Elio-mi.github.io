...
![image-20231104152232252](/assets/img/remote/gitee.com/ba270bbadb0868bf6acfa371.png)

我们只需要一行指令就可以实现我们想要的结果：就是图中橙色框框中的命令，这个命令就是将我们的环境变量更改为我们当前的目录；

![image-20231104152537479](/assets/img/remote/gitee.com/b98d562d4af0fb6659040095.png)

但是似乎又出问题了当我们尝试使用系统自带的命令时，出问题了！

![image-20231104153211752](/assets/img/remote/gitee.com/7304400d394772b941217cb0.png)
...
![image-20231104154846665](/assets/img/remote/gitee.com/e89379b36098763f861008a8.png)
...
![image-20231104155335539](/assets/img/remote/gitee.com/c2d57ed126b0256755f2af67.png)
...
>
> ![image-20231105163205931](/assets/img/remote/gitee.com/d5313b61e9dcf8b76789dd3e.png)
>
...
>![](/assets/img/remote/gitee.com/4f1c071bcbf87bd0fe2716ff.png)
>
...
> ```
>
> ![image-20231105171023137](/assets/img/remote/gitee.com/7baa746d2840297d16245d1e.png)
...
>
> ![image-20231105173406705](/assets/img/remote/gitee.com/b7692648dd784effc37d69cc.png)
>
...
> 系统的相关配置文件中读取出来的！
>
> ![image-20231105173930190](/assets/img/remote/gitee.com/e9014815c8c340076952a146.png)

## 环境变量通常是具有全局属性的  

> 首先我们在bash下输入这样一条指令：
>
> ![image-20231105180419628](/assets/img/remote/gitee.com/18ba93d7c7eae39952348bd6.png)
>
...
>
> ![image-20231105180817527](/assets/img/remote/gitee.com/4b0c42c0abc5bf1834bbdd45.png)
>
> 这时候我们再次调用`env`指令去环境变量里去找一下，结果是我们找到了这个变量：
>
> ![image-20231105181117251](/assets/img/remote/gitee.com/d2468f4e802c13aa99996ed3.png)
>
...
>
> ![image-20231105181711205](/assets/img/remote/gitee.com/f3bca9b4d7be86dad620ced0.png)
>
...
>
> ![image-20231105215048610](/assets/img/remote/gitee.com/549cbddb6ef133a136b4a911.png)
>
> ②`[`
>
...
> ```
>
> ![image-20231106150142779](/assets/img/remote/gitee.com/d13efafcfa2c3e7d8c2e5e58.png)
