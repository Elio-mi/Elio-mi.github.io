...
![image-20231123212353868](/assets/img/remote/gitee.com/8d84329f2bd636434da54335.png)

`who | wc -l`其中的`wc -l`表示统计输出结果的行数然后输出，那么整体的运行结果就表示的是当前Linux系统中有多少个用户登录

![image-20231123212546537](/assets/img/remote/gitee.com/7f67adcd847893beb444b599.png)
...
![image-20231123213537515](/assets/img/remote/gitee.com/354bc65d4f4b45a4005f1b5a.png)
...
![管道原理图](/assets/img/remote/gitee.com/d15975bcb51bb791406f2e8a.png)
...
![image-20231124150856768](/assets/img/remote/gitee.com/ad43b51f7aa8da90fa7b537b.png)
...
![image-20231124211108964](/assets/img/remote/gitee.com/9b7c6cb485d07d6cd5ad2592.png)
...
> ```
>
> ![image-20231124211820571](/assets/img/remote/gitee.com/ab8ce06548333bcfbeb0c35b.png)
>
> 3.如果关闭了写端，读取完毕，在读，read就返回0，表明读到了文件结尾。
>
> ![image-20231124191750420](/assets/img/remote/gitee.com/d527c567bfe6f0e57487b3b0.png)
>
> 4.写端一直写，读端关闭，会发生什么？没有意义！OS不会维护无意义，低效率，或者浪费资源的事情，OS会杀死一直在写入的进程！OS会通过信号来终止进程，13）SIGPIPE
>
> 我们收一条指令之后五秒之后关闭父进程对应的读端，发现子进程也退出了！
>
> ![image-20231124214343431](/assets/img/remote/gitee.com/1d8c9a990317d522e3d47763.png)
...
![image-20231124231658337](/assets/img/remote/gitee.com/a7c32c7108d8d4e315a46422.png)
...
![image-20231125121913303](/assets/img/remote/gitee.com/9107f826bd8b7b02a17fa8bf.png)
