...
![image-20231130191729999](/assets/img/remote/gitee.com/64fa05640c35034cd0c13e42.png)
...
![image-20231130195042509](/assets/img/remote/gitee.com/f8ab221c45ee2cc5478d6b05.png)
...
![image-20231130213324725](/assets/img/remote/gitee.com/39b95e3eb14247aefc8c82a8.png)
...
![image-20231130215301165](/assets/img/remote/gitee.com/b7ac9023a596233d8e10cc1d.png)
...
- ipcs -m
  ...
  > 查看系统中存在的共享内存：
  >
  > ![image-20231204172852789](/assets/img/remote/gitee.com/d1b7ee1aac09109542306147.png)

- ipcrm -m shmid

  > 删除shmid所对应的共享内存,<u>**共享内存的声明周期不随进程，随OS。**</u>。
  >
  > ![image-20231204173020261](/assets/img/remote/gitee.com/1f2edd98d0ff1501a66ee793.png)

- shmctl

  这是一个函数接口：用来查看共享内存的一些相关属性，<u>**前提是我们执行这个进程的用户具有查看当前共享内存属性的权限**</u>，否则无法查看，一般sudo运行即可。或者创建时权限修改为066即可.

  ![image-20231204203451118](/assets/img/remote/gitee.com/58a13f7ae17d92fe4f17e62b.png)
  ...
  ![image-20231204203711729](/assets/img/remote/gitee.com/e7bc93caa1b46c20d18c2050.png)
...
>
> ![image-20231205133313831](/assets/img/remote/gitee.com/b3b70b13f8d8f3b16ba149f3.png)
>
...
>
>   ![image-20231205134727851](/assets/img/remote/gitee.com/f1ac93c9965f89793314e77c.png)
>
> - shmflg中的一些：
>
> 比如：SHM_RDONLY
>
> ![image-20231205134520832](/assets/img/remote/gitee.com/3743a72ff5c0e7ee1a0df626.png)

- shmdt

  > 用于进程和对应的共享内存取消关联，相当于我们c语言当时学习的动态内存管理部分的free函数。
  >
  > ![image-20231205170541704](/assets/img/remote/gitee.com/e396bb4cd97b847fde8b5406.png)
