...
![image-20221214215148977](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20221214215148977.png - 图片需要手动处理 -->)

## 4热键(2)：

1.`crtl + r` : 搜索之前输入过的命令：

![image-20221214215803469](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20221214215803469.png - 图片需要手动处理 -->)
...
![image-20221214220247229](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20221214220247229.png - 图片需要手动处理 -->)

3.1`history > cmd.txt` 将历史命令存在cmd.txt中：

![image-20221214220516424](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20221214220516424.png - 图片需要手动处理 -->)
...
![image-20221214225024177](<!-- 原始路径: C:\Users\jason\AppData\Roaming\Typora\typora-user-images\image-20221214225024177.png - 图片需要手动处理 -->)
