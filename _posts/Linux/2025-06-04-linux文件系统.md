...
![image-20231112175415441](/assets/img/remote/gitee.com/f3f0b3f52775b2ebf0a568be.png)

一些参数：

![image-20231112184405352](/assets/img/remote/gitee.com/674c3b47491c64f490065cc2.png)

②`perror`函数:用于将错误码装化成对用的`strerror`

![image-20231112175639963](/assets/img/remote/gitee.com/73147b8f6b1371ff987e19aa.png)

③`fclose`函数

![image-20231112180051947](/assets/img/remote/gitee.com/b460c11c04f1af69ed295543.png)

④`fputs`函数：向文件中写入

![image-20231112180231175](/assets/img/remote/gitee.com/8cdefb2262fcfcb015e9ee97.png)
...
![image-20231112181203458](/assets/img/remote/gitee.com/03478387470a1bc573de63b7.png)
...
![image-20231112182333353](/assets/img/remote/gitee.com/84be81ceee3ddb9a328fed85.png)
...
![image-20231112182923960](/assets/img/remote/gitee.com/9ead3b5a7addf7d86c89397e.png)
...
![image-20231112184036214](/assets/img/remote/gitee.com/fa8c2aaa36d7ddac6f5c9313.png)

⑥`stdout`

那么我们观察到它们的类型都是我们对应的`FILE`，**因为在Linux系统中一切皆文件**，接下来我们尝试用`fprintf`函数向`stdout`中输出一些字符串看看

![image-20231112183052514](/assets/img/remote/gitee.com/ccc0cf399b7906db3fb44740.png)
...
![image-20231112183450307](/assets/img/remote/gitee.com/4e14642ee9894023026f4d25.png)
...
![image-20231112185104125](/assets/img/remote/gitee.com/163268d53f463801a29db65b.png)
...
![image-20231112185909086](/assets/img/remote/gitee.com/bf8b551bdca0d687d8edda14.png)

返回值：

返回一个文件描述符，-1表示错误，然后回设置`error`

![image-20231112190103226](/assets/img/remote/gitee.com/f42860c56bf99992e43f6392.png)
...
![image-20231112190508804](/assets/img/remote/gitee.com/b0308f14c8fde6498ec42411.png)

![image-20231112190641570](/assets/img/remote/gitee.com/cbcd21850a5b2d48b451630e.png)
...
![image-20231112192748966](/assets/img/remote/gitee.com/768a5c6d902bd8eb980caaad.png)
...
![image-20231112194839982](/assets/img/remote/gitee.com/88b0b695f70b268d2fd654a5.png)
...
![image-20231112194856013](/assets/img/remote/gitee.com/efc77f35cc54a2a8ce23a038.png)

但是我们去尝试查看这个文件的时候：

![image-20231112195241507](/assets/img/remote/gitee.com/afe7fdc8369b2159dbcb5e69.png)
...
![image-20231112195528363](/assets/img/remote/gitee.com/2fd622057cd588fc9bdd44cc.png)

但是我们发现文件`log.txt`的权限却不是0666，原因其实是因为文件的权限还受`umask`的影响：**默认权限&(~mask)**

我们查看一下`umask`是否是2：果然如此我们把它改成0000在运行一下程序看看

![image-20231112195724141](/assets/img/remote/gitee.com/3913ee5c61a3c61e6527c39f.png)

是我们想要的结果了!

![image-20231112195825596](/assets/img/remote/gitee.com/e906732c99d7dba65e1a2c92.png)
...
![image-20231112200426541](/assets/img/remote/gitee.com/2ae5d9b6efc3da70cc531a2d.png)
...
![image-20231112201547388](/assets/img/remote/gitee.com/973ccd3b9116c5980f5b6eb1.png)
...
![image-20231112203754608](/assets/img/remote/gitee.com/2f17934fe2ccd3538455f91e.png)
...
![image-20231112204423201](/assets/img/remote/gitee.com/f13246b11a1689fb6370979e.png)
