...
>   
>     ![image-20231103155817075](/assets/img/remote/gitee.com/c6a5cd687e54e3bdbfc5a9fb.png)
>   
>     我们看到这里的状态不是R,却是S+;
>   
>     但是当我们把C代码中的打印函数注释了之后再运行一下看看，进程的状态却变成R：
>   
>     ![image-20231103163959259](/assets/img/remote/gitee.com/46d05598e5d19a2d6131b6dc.png)
>   
>     那么为什么会这样呢？
>   
...
>   
>     ![image-20231103170137877](/assets/img/remote/gitee.com/e92d437af6622815499e7ed0.png)
>   
...
>     运行的效果：
>   
>     ![image-20231103200042615](/assets/img/remote/gitee.com/b860bbfd1fa6ab7c03acab46.png)
>   
...
>   
>     ![image-20231103200351904](/assets/img/remote/gitee.com/1ff056208ae1bd621187bd90.png)
>   
>     接下来我们尝试去使用一下这个命令看会产生什么效果，首先我们找到当前运行的进程的`pid`,然后再使用`kill -19`:暂停进程，这时候我们再去查看进程的状态：
>   
>     ![image-20231103201029386](/assets/img/remote/gitee.com/83b92d32da39b4238f7de052.png)
>   
>     首先我们可以观察到两点：
>   
>     ①进程确实被暂停了；
...
>   
>     ![image-20231103201307320](/assets/img/remote/gitee.com/168fead98d250ff33446cfdb.png)
>   
...
>   
>     ![image-20231103201752937](/assets/img/remote/gitee.com/d7d8b8588ac44fd380604ee4.png)
>   
>     那么我们怎么杀掉这个进程呢？
>   
>     我们使用`kill`命令中的编号为`-9`的命令来杀掉这个进程就可以了。
>   
>     ![image-20231103202157343](/assets/img/remote/gitee.com/06e05c888ea15db3896a863b.png)
>
...
>
> ​		![image-20231103204516129](/assets/img/remote/gitee.com/5ad23701c477c8e559d34405.png)
>
> ![image-20231103204605905](/assets/img/remote/gitee.com/324bd37eb4e34502d6323217.png)
>
...
![image-20231104134321240](/assets/img/remote/gitee.com/cb1576215adbb08f826a5999.png)
