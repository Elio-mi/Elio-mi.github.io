...
![](/assets/img/remote/gitee.com/d66937847dad320e05364497.png)

包括我们甚至可以找到我们经常使用的`stdio.h`标准库，并且可以使用vim编辑器进行查看的！

![image-20231121142639688](/assets/img/remote/gitee.com/64fb971b96c67a2b838199ed.png)
...
![image-20231121165901487](/assets/img/remote/gitee.com/81c0f1cd4c2637339a40d0b7.png)

我们将.c源文件都让其生成.o文件，也就是未链接前的文件：

利用ar命令生成静态库：`ar -rc libmymath.a myadd.o mysub.o`

![image-20231121174308280](/assets/img/remote/gitee.com/74f80034aee1af31efc015cc.png)

当我们把`libmymath.a`文件挪动到我们的`ortherperson`目录下的时，我们尝试编译的时候：

发现提示我们找不到头文件

![image-20231121174153962](/assets/img/remote/gitee.com/5660a70e336049504e0ac8b0.png)
...
![image-20231121174529404](/assets/img/remote/gitee.com/1592710d4b24a9c479e6975e.png)
...
![image-20231121180401518](/assets/img/remote/gitee.com/727abe93439844da396777c8.png)
...
![image-20231121185348586](/assets/img/remote/gitee.com/35378d8074efa892e4190244.png)
...
![image-20231121185748618](/assets/img/remote/gitee.com/efe226c72707609736c78d64.png)
...
![image-20231121190107295](/assets/img/remote/gitee.com/16b0d6ad68589ba5b1dc3d1f.png)
...
>
> ![image-20231121192516738](/assets/img/remote/gitee.com/0eff4fd99a4b6e9582335eb4.png)
>
> 我们ldd查看一下链接的情况并且运行一下：
>
> ![image-20231121192541623](/assets/img/remote/gitee.com/9aefb4c9e87fb84e54f9d953.png)
>
...
> 这个时候ldd我们再去查看的时候：
>
> ![image-20231121193409826](/assets/img/remote/gitee.com/78b7bcb8f694009ffb79d4f3.png)
>
> 并且我们这时候再去运行发现是没有任何问题的：
>
> ![image-20231121193534934](/assets/img/remote/gitee.com/12562a19ccea97749828a1c8.png)
>
...
> 我们ldd查看一下：
>
> ![image-20231122150326397](/assets/img/remote/gitee.com/1199a36a770877cf44d1725f.png)
>
...
> 运行一下看看：
>
> ![image-20231122150654301](/assets/img/remote/gitee.com/054e98c88f6b4bea675beff2.png)
>
> 尝试运行：
>
> ![image-20231122150722572](/assets/img/remote/gitee.com/5951106ad461db66edf9c473.png)
...
![image-20231122154713731](/assets/img/remote/gitee.com/4eff07ade08044ea6f787206.png)
...
![image-20231122171305250](/assets/img/remote/gitee.com/57778bae80b214cb5550f40c.png)

接下来我们有一个问题，当静态库和动态库同时存在的情况下，我们的可执行文件会优先使用哪个呢？**答案肯定是动态库**

我们试验一下：重新编译文件并运行

![image-20231122171700679](/assets/img/remote/gitee.com/e02d3e82793699ea619a0b44.png)

我们ldd查看一下可执行程序的链接情况：很显然是我们的动态库！

![image-20231122171733025](/assets/img/remote/gitee.com/fffff65a1eeb795e09be102d.png)
...
![image-20231122183954762](/assets/img/remote/gitee.com/d1a0d237cd94b5e9c103fd04.png)
...
![image-20231122184419491](/assets/img/remote/gitee.com/df7c99b42fbbc32632bfb976.png)
