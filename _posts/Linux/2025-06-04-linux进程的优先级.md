...
> `ps -l`
>
> ![image-20231106154450428](/assets/img/remote/gitee.com/88985f19948e101cb3293a47.png)
>
> 我们很容易注意到有以下几个信息:
>
...
![image-20231106155913887](/assets/img/remote/gitee.com/a51bef4ed3d105d8e578edbb.png)

然后我们输入修改后的`nice`值，这里我们随便输入一个 -10；

![image-20231106160012888](/assets/img/remote/gitee.com/800eef9ba29b519462a8f551.png)

`ps -al`查看一下`pri`这个进程的`PRI`和`NI`值的变化。

![image-20231106160120378](/assets/img/remote/gitee.com/ca57aad55638bf83a8814cac.png)

我们在试试将`nice`值修改成80；

![image-20231106160224999](/assets/img/remote/gitee.com/1afacf7f4dd2c92905d3f290.png)

我们发现nice值并没有被修改成80，而是被修改成了19，这是因为nice值得边界限制了。

![image-20231106160311968](/assets/img/remote/gitee.com/2faa1e5ac262442bb185e388.png)